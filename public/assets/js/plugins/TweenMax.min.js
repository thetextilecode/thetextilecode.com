  ...
  (_gsScope._gsDefine(
    ...
    function (t, e, i) {
                      ...
                      1 === u
                        ...
                        : 2 === u
                          ...
                          : 3 === u
                            ...
                            : 4 === u && (h *= h * h * h * h),
                      (this.ratio =
                        1 === _ ? 1 - h : 2 === _ ? h : 0.5 > this._time / g ? h / 2 : 1 - h / 2))
      ...
      var p = function (t, i, s, r) {
        ...
        for (var n, a, o = f(r), l = i && s && r, h = o.length; --h > -1; )
          ((a = o[h]),
            (l || a instanceof e || ((n = a.target === a.vars.onComplete) && s) || (i && !n)) &&
              a.paused(t));
      };
      return (
      ...
      function (t, e, i) {
        ...
        return (
          ...
          (d.totalDuration = function (t) {
            ...
            return (
              0 !== this.totalDuration() && 0 !== t && this.timeScale(this._totalDuration / t),
              this
            );
          }),
          (d.paused = function (e) {
          ...
          (h.render = function (t, e, i) {
            ...
            if (t >= f)
              ...
              if (
                ...
                (this._time = 0),
                (0 !== m ||
                  (0 === p && y !== r && (y > 0 || (0 > t && y >= 0)) && !this._locked)) &&
      ...
      var t = 180 / Math.PI,
        ...
        f = function (t, e, i) {
          for (var s, r, n, a, o, l, h, _, u, c, f, p = 1 / i, m = t.length; --m > -1; )
            for (
              c = t[m], n = c.a, a = c.d - n, o = c.c - n, l = c.b - n, s = r = 0, _ = 1;
              i >= _;
              _++
            )
              ((h = p * _),
    ...
    _gsScope._gsDefine(
      ...
      function (t, e) {
        ...
        for (h in oe) ue += '|' + h + '\\b';
        ((ue = RegExp(ue + ')', 'gi')),
          (a.variationstringFilter = function (t) {
            var e,
              i = t[0] + t[1];
            ((ue.lastIndex = 0),
              ue.test(i) &&
          ...
          e.defaultStringFilter || (e.defaultStringFilter = a.variationstringFilter));
            ...
            return _
              ? (r = e
                  ? function (t) {
                      ...
                      return (
                        o + c.join(h) + h + e + l + (-1 !== t.indexOf('inset') ? ' inset' : '')
                      );
                    }
                  : function (t) {
                      var e, n, c;
                ...
                ? (a.l++,
                  ...
                  o > 0
                    ? ((a.data['xn' + o] = e + i),
                      ...
                      (a['xn' + o] = e),
                      a.plugin ||
                        ((a.xfirst = new me(a, 'xn' + o, e, i, a.xfirst || a, 0, a.n, r, a.pr)),
                        (a.xfirst.xs0 = 0)),
                      a)
        ...
        var we,
          ...
          Ee = function (t, e) {
            ...
            for (r = (s || '').match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], ve = r.length; --ve > -1; )
              ((n = Number(r[ve])),
                (r[ve] = (a = n - (n |= 0)) ? (0 | (a * l + (0 > a ? -0.5 : 0.5))) / l + n : n));
            ...
            if (
              ...
              if (16 === o.length) {
                ...
                ((f.x = o[4] || 0),
                  ...
                  (f.skewX = c),
                  Re &&
                    ((f.rotationX = f.rotationY = f.z = 0), (f.perspective = v), (f.scaleZ = 1)),
                  f.svg &&
                ...
                for (
                  f = s.ieOffsetX || 0,
                    ...
                    s.ieOffsetX = Math.round(
                      (d - ((0 > o ? -o : o) * d + (0 > l ? -l : l) * g)) / 2 + w
                    ),
                    s.ieOffsetY = Math.round(
                      (g - ((0 > _ ? -_ : _) * g + (0 > h ? -h : h) * d)) / 2 + b
                    ),
                    ve = 0;
                  4 > ve;
                  ve++
                ...
                return (
                  ...
                  (f || (Re && p && h.zOrigin)) &&
                    (Pe
                      ...
                      : se(f + '', h)),
                  m &&
                    (s._transformType = (h.svg && we) || (!p && 3 !== this._transformType) ? 2 : 3),
                  n
                );
              },
              prefix: !0,
          ...
          Te('backgroundPosition', {
            ...
            parser: function (t, e, i, s, n, a) {
              ...
              if (
                ...
                for (
                  o = d.split(' '), l = g.split(' '), X.setAttribute('src', c), h = 2;
                  --h > -1;
                )
                  ((d = o[h]),
                    (_ = -1 !== d.indexOf('%')),
          ...
          if (
            ...
            if ('all' === this.e) ((a.cssText = ''), (r = !0));
              ...
              for (e = this.e.split(' ').join('').split(','), s = e.length; --s > -1; )
                ((i = e[s]),
                  l[i] &&
                    (l[i].parse === o ? (r = !0) : (i = 'transformOrigin' === i ? Se : l[i].p)),
                  je(a, i));
            r &&
              (je(a, Pe),
              (n = this.t._gsTransform),
              n &&
                (n.svg && this.t.removeAttribute('data-svg-origin'), delete this.t._gsTransform));
          }
        };
        for (
          Te('clearProps', {
                          ...
                          (!h && 0 !== h) || (!u && 0 !== u)
                            ? void 0 !== v[a] && (f || ('NaN' != f + '' && null != f))
                              ? ((i = new me(v, a, u || h || 0, 0, i, -1, a, !1, 0, c, f)),
                                (i.xs0 =
                                  'none' !== f || ('display' !== a && -1 === a.indexOf('Style'))
                                    ? f
                                    : c))
    ...
    if (!i.TweenLite) {
      ...
      var v = [0, 0, 1, 1],
        ...
        w = (T.register = function (t, e, i, s) {
          for (
            ...
            for (
              n = l[_], r = s ? g('easing.' + n, null, !0) : h.easing[n] || {}, a = u.length;
              --a > -1;
            )
      ...
      (g('Ticker', function (t, e) {
        ...
        (b.call(h),
          ...
          (h.sleep = function () {
            null != r &&
              (f && k ? k(r) : clearTimeout(r), (s = c), (r = null), h === a && (o = !1));
          }),
          (h.wake = function () {
          ...
          (h.fps = function (t) {
            return arguments.length
              ? ((i = t), (n = 1 / (i || 60)), (l = this.time + n), h.wake(), void 0)
              : i;
          }),
          (h.useRAF = function (t) {
        ...
        (n.eventCallback = function (t, e, i, s) {
          if ('on' === (t || '').substr(0, 2)) {
            ...
            (null == e
              ...
              : ((r[t] = e),
                (r[t + 'Params'] =
                  f(i) && -1 !== i.join('').indexOf('{self}') ? this._swapSelfInParams(i) : i),
                (r[t + 'Scope'] = s)),
      ...
      var D = g(
          ...
          function (e, i, s) {
            ...
            if (
              ((this._overwrite = l =
                null == l ? V[D.defaultOverwrite] : 'number' == typeof l ? l >> 0 : V[l]),
      ...
      var F = [],
        ...
        X = function (t, e, i, s, r, n, a, o) {
          ...
          return (
            ...
            f.c
              ? ((f._next = this._firstPT) && (f._next._prev = f), (this._firstPT = f), f)
              : void 0
          );
        },
