        ...
        <article className="first-post mb-30 wow fadeIn animated hover-up">
          ...
          <div className="entry-content">
            <div className="entry-meta meta-1 mb-30">
              <Link href="/blog-category-grid" className="entry-meta meta-0">

                <span className="post-in background4 text-brand font-xs">Mobile Phone</span>
            ...
            <p className="post-excerpt font-medium text-muted mb-30">{item.description}</p>
            <div className="mb-20 entry-meta meta-2">
              <div className="font-xs ">
                <span className="post-by">
                  By {/*<Link href='/blog-category-grid'>*/}
                  {/*  <a>{item.category}</a>*/}
                  {/*</Link>*/}
                </span>
                <span className="post-on">{item.date}</span>
                <span className="time-reading">8 mins read</span>
                <p className="font-xs mt-5">Updated 18/08/2021 07:12 EST</p>
              </div>
